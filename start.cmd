...
start "Backend API (port 8000)" cmd /k "cd /d "%~dp0" && venv\Scripts\python.exe start_server.py"

:: arq background worker
echo [2/3] Starting arq worker...
start "arq Worker" cmd /k "cd /d "%~dp0" && venv\Scripts\python.exe run_worker.py"
